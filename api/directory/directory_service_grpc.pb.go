...
const (
	Directory_GetDirectory_FullMethodName    = "/resource.api.directory.Directory/GetDirectory"
	Directory_ListDirectory_FullMethodName   = "/resource.api.directory.Directory/ListDirectory"
	Directory_CreateDirectory_FullMethodName = "/resource.api.directory.Directory/CreateDirectory"
	Directory_UpdateDirectory_FullMethodName = "/resource.api.directory.Directory/UpdateDirectory"
	Directory_DeleteDirectory_FullMethodName = "/resource.api.directory.Directory/DeleteDirectory"
)
...
type DirectoryClient interface {
	...
	ListDirectory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListDirectoryReply, error)
...
func (c *directoryClient) ListDirectory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListDirectoryReply, error) {
...
type DirectoryServer interface {
	...
	// ListDirectory 获取文件目录信息列表
	ListDirectory(context.Context, *emptypb.Empty) (*ListDirectoryReply, error)
	// CreateDirectory 创建文件目录信息
...
func (UnimplementedDirectoryServer) ListDirectory(context.Context, *emptypb.Empty) (*ListDirectoryReply, error) {
...
func _Directory_ListDirectory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirectoryServer).ListDirectory(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Directory_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "resource.api.directory.Directory",
	...
	Metadata: "api/directory/proto/directory_service.proto",
}
