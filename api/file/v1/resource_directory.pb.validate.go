...
// Validate checks the field values on AllDirectoryRequest with the rules
...
// ValidateAll checks the field values on AllDirectoryRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AllDirectoryRequestMultiError, or nil if none found.
func (m *AllDirectoryRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AllDirectoryRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetApp()) < 0 {
		err := AllDirectoryRequestValidationError{
			field:  "App",
	...
	if len(errors) > 0 {
		return AllDirectoryRequestMultiError(errors)
	}

	return nil
}

// AllDirectoryRequestMultiError is an error wrapping multiple validation
// errors returned by AllDirectoryRequest.ValidateAll() if the designated
// constraints aren't met.
type AllDirectoryRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AllDirectoryRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AllDirectoryRequestMultiError) AllErrors() []error { return m }

// AllDirectoryRequestValidationError is the validation error returned by
// AllDirectoryRequest.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AllDirectoryRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AllDirectoryRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AllDirectoryRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AllDirectoryRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AllDirectoryRequestValidationError) ErrorName() string {
	return "AllDirectoryRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AllDirectoryRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAllDirectoryRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AllDirectoryRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AllDirectoryRequestValidationError{}

// Validate checks the field values on AllDirectoryReply with the rules defined
...
// ValidateAll checks the field values on AllDirectoryReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AllDirectoryReplyMultiError, or nil if none found.
func (m *AllDirectoryReply) ValidateAll() error {
	return m.validate(true)
}

func (m *AllDirectoryReply) validate(all bool) error {
	if m == nil {
		return nil
	}
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AllDirectoryReplyValidationError{
			...
			if err := v.Validate(); err != nil {
				return AllDirectoryReplyValidationError{
					field:  fmt.Sprintf("List[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return AllDirectoryReplyMultiError(errors)
	}

	return nil
}

// AllDirectoryReplyMultiError is an error wrapping multiple validation errors
// returned by AllDirectoryReply.ValidateAll() if the designated constraints
// aren't met.
type AllDirectoryReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AllDirectoryReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AllDirectoryReplyMultiError) AllErrors() []error { return m }

// AllDirectoryReplyValidationError is the validation error returned by
// AllDirectoryReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AllDirectoryReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AllDirectoryReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AllDirectoryReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AllDirectoryReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AllDirectoryReplyValidationError) ErrorName() string {
	return "AllDirectoryReplyValidationError"
}

// Error satisfies the builtin error interface
func (e AllDirectoryReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAllDirectoryReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AllDirectoryReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AllDirectoryReplyValidationError{}
